...
class GroupingOperation(Function):
    ...
    def forward(ctx, features: torch.Tensor,
        ...
        _, C, N = features.size()
        output = torch.tensor((B, C, nfeatures, nsample), dtype=torch.float32).to(os.environ.get("GPU_DEVICE", "cpu"))
    ...
    def backward(ctx,
        ...
        grad_features = torch.tensor((B, C, N), dtype=torch.float32).to(os.environ.get("GPU_DEVICE", "cpu")).zero_()
