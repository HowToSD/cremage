...
class FurthestPointSampling(Function):
    ...
    def forward(ctx, points_xyz: torch.Tensor,
        ...
        output = torch.tensor((B, num_points), dtype=torch.int32).to(os.environ.get("GPU_DEVICE", "cpu"))
        temp = torch.tensor((B, N), dtype=torch.float32).to(os.environ.get("GPU_DEVICE", "cpu")).fill_(1e10)
