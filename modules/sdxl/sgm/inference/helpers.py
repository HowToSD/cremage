...
def get_batch(keys, value_dict, N: Union[List, ListConfig], device=os.environ.get("GPU_DEVICE", "cpu")):
...
def get_input_image_tensor(image: Image.Image, device=os.environ.get("GPU_DEVICE", "cpu")):
    w, h = image.size
