...
def inference_two_images(model_path, img1, img2, save_path, gpu, inter_frames, fps, half):
    ...
    for i, frame in enumerate(frames):
        writer.write(frame)
        # cv2.imwrite(f"tmp_frame_{i:06d}.jpg", frame)

    # frame 5, frame 4, frame 3, frame 2, frame 1
    for frame in frames[1:][::-1]:  # Skip frame 0, and reverse the order
        writer.write(frame)
...
if __name__ == '__main__':
    ...
    args = parser.parse_args([
        ...
        "/home/pup/data/programs/python/cremage_resources/1024x576_red_blouse.png",
        "/home/pup/data/programs/python/cremage_resources/1024x576_red_blouse2.png",
        "--save_path", "/home/pup/data/programs/python/cremage_resources/tmp/tmp.mp4",
        "--frames", "24",
        "--gpu",
        "--fps", "24"
    ])

    inference_two_images(args.model_path, args.img1, args.img2, args.save_path, args.gpu, args.frames, args.fps, args.fp16)
